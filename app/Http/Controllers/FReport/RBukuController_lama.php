	...
	public function jasperBukuReport(Request $request) 
	{
		...
		(
			...
			(
				...
				and kas.BACNO between '$acno' and '$acno2' GROUP BY KAS.BACNO union all
				
				SELECT kasd.ACNO AS BACNO, kasd.NACNO AS BNAMA, SUM(kasd.DEBET-kasd.KREDIT) AS AWAL 
				from kas, kasd where kas.NO_BUKTI = kasd.NO_BUKTI and kas.TGL<'$tglDrD' 
				and kasd.ACNO between '$acno' and '$acno2' GROUP BY KASD.ACNO union all
				...
				and bank.BACNO between '$acno' and '$acno2' GROUP BY BANK.BACNO union all

				SELECT bankd.ACNO AS BACNO, bankd.NACNO as BNAMA, SUM(bankd.DEBET-bankd.KREDIT) AS AWAL 
				from bank, bankd where bank.NO_BUKTI = bankd.NO_BUKTI and bank.TGL<'$tglDrD' 
				and bankd.ACNO between '$acno' and '$acno2' GROUP BY BANKD.ACNO union all
				...
				and memod.ACNO between '$acno' and '$acno2' GROUP BY MEMOD.ACNO union all

				SELECT memod.ACNOB as BACNO, memod.NACNOB as BNAMA, SUM(memod.KREDIT) * -1 AS AWAL 
				from memo, memod where memo.NO_BUKTI = memod.NO_BUKTI and memo.TGL<'$tglDrD' 
				and memod.ACNOB between '$acno' and '$acno2' GROUP BY MEMOD.ACNOB
			...
			from kas, kasd where kas.NO_BUKTI=kasd.NO_BUKTI and kas.TGL BETWEEN '$tglDrD' and '$tglSmpD' and kas.BACNO between '$acno' and '$acno2'
			...
			from kas, kasd where kas.NO_BUKTI=kasd.NO_BUKTI and kas.TGL BETWEEN '$tglDrD' and '$tglSmpD' and kasd.ACNO between '$acno' and '$acno2'
			...
			from bank, bankd where bank.NO_BUKTI=bankd.NO_BUKTI and bank.TGL BETWEEN '$tglDrD' and '$tglSmpD' and bank.BACNO between '$acno' and '$acno2'
			...
			from bank, bankd where bank.NO_BUKTI=bankd.NO_BUKTI and bank.TGL BETWEEN '$tglDrD' and '$tglSmpD' and bankd.ACNO between '$acno' and '$acno2'
			...
			from memo, memod where memo.NO_BUKTI=memod.NO_BUKTI and memo.TGL BETWEEN '$tglDrD' and '$tglSmpD' and memod.ACNO between '$acno' and '$acno2'
