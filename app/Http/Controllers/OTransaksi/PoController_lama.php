...
class PoController extends Controller
{
    ...
    {
        $po = DB::table('po')->select('NO_BUKTI', 'TGL', 'KODES', 'NAMAS', 'ALAMAT', 'KOTA', 'KD_BRG', 'NA_BRG', 'HARGA', 'KG', 'KIRIM', 'SISA', 'TOTAL')->where('SLS', 0)->where('GOL', $request->GOL )->orderBy('KODES', 'ASC');
