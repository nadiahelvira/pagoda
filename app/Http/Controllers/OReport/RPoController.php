...
class RPoController extends Controller
{
	...
	public function jasperPoReport(Request $request) 
	{
		...
		$query = DB::SELECT("
			SELECT po.NO_BUKTI, DATE_FORMAT(po.TGL,'%d/%m/%Y') AS TGL, po.KODES, po.NAMAS, po.KD_BRG, po.NA_BRG, po.KG, po.HARGA, po.TOTAL, po.NOTES, po.GOL, po.KIRIM, po.SISA from po
