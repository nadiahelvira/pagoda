...
class RPiuController extends Controller
{
	...
	public function jasperPiuReport(Request $request) 
	{
		...
		SELECT * from 
		(
			SELECT piu.NO_BUKTI,piu.BACNO,piu.BNAMA,piu.NO_SO,DATE_FORMAT(piu.TGL,'%d/%m/%Y') AS TGL,piu.KODEC,piu.NAMAC,piud.NO_FAKTUR,piud.TOTAL,piud.BAYAR,piud.SISA,piu.GOL, 
