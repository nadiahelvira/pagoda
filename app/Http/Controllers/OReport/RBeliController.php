...
class RBeliController extends Controller
{
   ...
   public function report()
	...
	public function jasperBeliReport(Request $request) 
	{
		...
		$query = DB::SELECT("
			SELECT trim(NO_BUKTI) as NO_BUKTI,DATE_FORMAT(TGL,'%d/%m/%Y') AS TGL,NO_PO,KODES,TRUCK,NAMAS,KD_BRG,trim(NA_BRG) as NA_BRG,KG,HARGA,
			LAIN, TOTAL, AJU, BL,EMKL, NOTES, RPRATE, RPLAIN, RPHARGA, RPTOTAL, ACNOA, NACNOA  
